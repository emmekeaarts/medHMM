...
#'  equal over the states.
#'
#' @param shift A scalar used to specify the shift for the shifted
...
#'
#' @return \code{medHMM_cont_shiftpois} returns an object of class \code{medHMM_cont_shiftpois}, which has
