...
Hier_HSMM_mnl_RW_seq <- function(Data, Start_Val, Gamma_Sampler = NULL, Pr_Sampler = NULL, Gamma_hyp_Prior = NULL, Pr_hyp_Prior = NULL, D_hyp_Prior, Mcmc, Fast_vers = FALSE, Fast_vers_par = NULL){
