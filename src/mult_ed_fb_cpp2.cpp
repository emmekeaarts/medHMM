...
// for an arbitrary emission distribution
//' @keywords internal
// [[Rcpp::export(rng = false)]]

List mult_ed_fb_cpp2(int m, int n, NumericVector delta, NumericMatrix allprobs, int Mx, IntegerVector Mx2, NumericMatrix gamma, NumericMatrix d, IntegerVector S, IntegerVector S2) {
